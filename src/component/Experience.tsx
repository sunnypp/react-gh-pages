...
const Component = ({ t }: { t: any }) => <Experience>
  <ExperienceContainer>
    ...
    <RoleContainer>
      <ExperienceList>
        <li><Trans i18nKey="experience.neto.experiences.0">Pioneered <a href="https://github.com/sunnypp/peri" target="_blank" rel="noreferrer">Peri</a> (ported <a href="https://jasmine.github.io" target="_blank" rel="noreferrer">JasmineJS</a> Automated Testing Framework to Perl), which is used in production. Earned me <Em>Developer of the Month</Em> 🏛️</Trans></li>
        <li><Trans i18nKey="experience.neto.experiences.1">Reduced <Em>95% of the "overwriting staging environments" deployment issue</Em> by launching a Slackbot 🤖</Trans></li>
